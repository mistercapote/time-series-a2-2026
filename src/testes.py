...
def verificar_intervalo_data(df: pd.DataFrame, data_inicio: str = None, data_fim: str = None) -> bool:
  """
...
def verificar_consistencia(df1: pd.DataFrame, df2: pd.DataFrame, data_inicio1: str = None, data_fim1: str = None, data_inicio2: str = None, data_fim2: str = None):
  """
  ...
  if not(verificar_intervalo_data(df1, data_inicio=data_inicio1, data_fim=data_fim1) and verificar_intervalo_data(df2, data_inicio=data_inicio2, data_fim=data_fim2)):
  ...
  if tudo_ok:
    print("SUCESSO: Os dados estão consistentes (Do tipo correto, ordenados, com datas únicas, no intervalo correto e sem vazamentos)")